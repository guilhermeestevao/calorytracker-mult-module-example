package dev.guilhermeestevao.core.domain.preferences

import android.content.SharedPreferences
import dev.guilhermeestevao.core.domain.model.ActivityLevel
import dev.guilhermeestevao.core.domain.model.Gender
import dev.guilhermeestevao.core.domain.model.GoalType
import dev.guilhermeestevao.core.domain.model.UserInfo
...
class DefaultPreferences(
    ...
    override fun loadUserInfo(): UserInfo {
        ...
        return UserInfo(
            ...
            weight = weight,
            height = height,
            activityLevel = ActivityLevel.fromString(activityLevelString ?: "midium"),
    ...
    override fun saveShouldShowOnboarding(showOnboarding: Boolean) {
        sharedPref.edit()
            .putBoolean(Preferences.KEY_SHOULD_SHOW_ONBOARDING, showOnboarding)
            .apply()
    }
